...
export default function PartyReportsPage() {
  ...
  const exportToExcel = () => {
    try {
      ...
      // Company header and styling info
      const companyInfo = [
      ...
      const title = selectedPartyName 
        ? `Purchase Report - ${selectedPartyName}`
      ...
      // Create data rows for the report
  ...
  const exportToPDF = () => {
    try {
      // Create document - A4 size in landscape
      const doc = new jsPDF({
      ...
      try {
        // Create SVG logo string for PDF
        const logoSvg = `
        ...
        reader.onloadend = function() {
          ...
          // License number positioned on left side with styling
          doc.setFontSize(9);
          doc.setTextColor(80, 80, 120);
          doc.text('License: NOC/ST/2025/1/24/467905', 15, 60);
          doc.setTextColor(0);

          // Draw a colorful decorative line separator
          const lineY = 69;
          // First line - blue
          ...
          // Find the selected party and create title
          const selectedParty = filters.party ? parties.find(p => p._id === filters.party) : null;
          const title = selectedParty 
            ? `${selectedParty?.name || 'Unknown Party'} - Purchase Report` 
            : 'Party Purchase Report';
  ...
  const handlePrint = () => {
    // Ensure the print view is properly prepared
    setTimeout(() => {
      window.print();
    }, 100);
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex flex-col items-center justify-between mb-8">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-3">Party Purchase Reports</h3>
            ...
            <div className="print:block hidden">
              ...
              <div className="text-center mb-6">
                <h2 className="text-xl font-bold mb-1">
                  {selectedPartyName ? `${selectedPartyName} - Purchase Report` : 'Party Purchase Report'}
                </h2>
